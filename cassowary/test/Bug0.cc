// $Id: Bug0.cc,v 1.1 2003/08/21 15:34:29 SVILEN Exp $
...
/* This bug fixed --02/15/99 gjb
   ...
   with a EditInfo class that is the Value of the _editVarMap map.
...
int main()
{
 ...
 perform a 'SimplexSolver.SuggestValue()', the indices of 
 'ConstraintAndIndex' in the variable 'cai' are sometimes wrong (see 
 SimplexSolver.SuggestValue(Variable v, double x), the 3rd line). This is 
